...
--
-- Host: localhost
-- Generation Time: Feb 28, 2011 at 11:40 AM
...
('11112111', 1, 'Bank IDR', '123456789', 'IDR', 'Indonesia', 'IDR', 1, 3, '0000-00-00 00:00:00', 0, 0);
...
CREATE TABLE IF NOT EXISTS `0_chart_types` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`name`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=90000001 ;
...
(12000000, 'AKTIVA TIDAK LANCAR', 1, 0, 0),
...
(21000000, 'HUTANG JANGKA PENDEK', 2, 0, 0),
...
(22000000, 'HUTANG JANGKA PANJANG', 2, 0, 0),
(31011000, 'MODAL DISETOR', 3, 0, 0),
(32021000, 'AGIO / DISAGIO', 3, 0, 0),
(33031000, 'PENILAIAN KEMBALI ATAS AKTIVA', 3, 0, 0),
(34041000, 'DIVIDEN', 3, 0, 0),
(35051000, 'LABA / (RUGI)', 3, 0, 0),
(41000000, 'PENJUALAN', 4, 0, 0),
(42000000, 'DISKON PENJUALAN', 4, 0, 0),
(44000000, 'RETUR PENJUALAN', 4, 0, 0),
(50000000, 'HARGA POKOK PENJUALAN', 5, 0, 0),
(59000000, 'SELISIH HPP', 5, 0, 0),
(61000000, 'BIAYA OPERATIONAL', 6, 0, 0),
...
(62000000, 'BIAYA PENYUSUTAN &amp; AMORTISASI', 6, 0, 0),
(62100000, 'BIAYA PENYUSUTAN', 6, 62000000, 0),
(62200000, 'BIAYA AMORTISASI', 6, 62000000, 0),
(70011000, 'PENDAPATAN LAIN-LAIN', 7, 0, 0),
(70021000, 'BIAYA LAIN-LAIN', 7, 0, 0),
(80000000, 'PAJAK PENGHASILAN', 6, 0, 0),
(90000000, 'MEMO', 6, 0, 0);
...
(1, 'Xini', '', '', 1, 1, 'N/A', '', '', '', '', '', 'IDR', '11131110', '51040000', '21102110', '70021170', '70011130', '35051020', '35051010', '61201190', '41001000', '42001000', '44001000', '11151100', '51010000', '51060000', '41001000', '51030000', '5000', 0, 5, 5, 1000000, 20, 20, 30, 1, 1, 0, 0, 0, 1, 0, 1, '', 1, '2.2', 0, -1, 1, 600);
...
(2, 'EUR', 13277.04, 13277.04, '2010-01-15'),
(4, 'USD', 9165.4287, 9165.4287, '2010-01-15');
...
(6, 'Komponen', 1, 'ea.', 'B', '41001000', '51010000', '11151100', '51060000', '51030000', 0, 0, 0, 1),
(7, 'Jasa', 1, 'ea.', 'D', '41002000', '51020000', '11151100', '51060000', '51030000', 0, 0, 0, 0),
(8, 'Barang Dagang', 1, 'ea.', 'B', '41001000', '51010000', '11151100', '51060000', '51030000', 0, 0, 0, 0),
(9, 'Barang Jadi', 1, 'ea.', 'M', '41001000', '51010000', '11151100', '51060000', '51030000', 0, 0, 0, 0);
...
(1, 'admin', '5f4dcc3b5aa765d61d8327deb882cf99', 'Administrator', 2, '', 'adm@adm.com', 'id_ID', 0, 0, 0, 0, 'xinix', 'Letter', 2, 2, 4, 1, 1, 0, 0, '2011-02-25 15:41:26', 10, 1, 1, '', 1, 0, 'orders', 0);
