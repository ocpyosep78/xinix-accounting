    ...
    <tr>
        <td>
            <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td width="20%"><?php echo $arg->compares['header']; ?></td><td><?php echo $arg->compares['period']; ?></td>
                    <td width="20%">&nbsp</td>
                </tr>
            </table>
        </td>
        ...
        <td>
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td class="head" width="10%">Accumulated</td>
                ...
                <?php foreach ($arg->classes as $class): ?>
                    ...
                    <?php foreach ($class['subclasses'] as $subclass): ?>
                        ...
                        <?php foreach ($subclass['accounts'] as $accounts): ?>
                            <tr>
                                ...
                                <td class="balance" width="10%"><?php echo $accounts['period'] ?></td>
                                <td class="balance" width="10%"><?php echo $accounts['acc'] ?></td>
                        ...
                        <tr>
                            ...
                            <td class="acc_footer balance" width="10%"><?php echo $subclass['total_period'] ?></td>
                            <td class="acc_footer balance" width="10%"><?php echo $subclass['total_acc'] ?></td>
                    ...
                    <tr>
                        ...
                        <td class="acc_footer balance" width="10%"><strong><?php echo $class['total_period']; ?></strong></td>
                        <td class="acc_footer balance" width="10%"><strong><?php echo $class['total_acc']; ?></strong></td>
                ...
                <?php endforeach ?>
                    ...
                    <tr>
                        ...
                        <td class="balance"><?php echo $arg->calculated_period * -1; ?></td>
                        <td class="balance"><?php echo $arg->calculated_acc * -1; ?></td>
